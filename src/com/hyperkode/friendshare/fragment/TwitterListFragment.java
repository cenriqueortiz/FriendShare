...
public class TwitterListFragment extends Fragment {
    ...
    public View onCreateView(
        ...
        return inflater.inflate(R.layout.twitter_list, container, false);
    }
    
    /**
     * onResume Fragment life-cycle method
     */
    @Override
    ...
    private void setupListView() {
        ...
        listView = (ListView) this.getActivity().findViewById(R.id.twitter_listview);
        ...
        // Set the Adapter
        mFriendStatusAdapter  = new FriendStatusAdapter(this.getActivity(), mFriendsStatus, R.layout.twitter_list_item);
    ...
    private void setupSearchButton() {
        Button searchButton = (Button) this.getActivity().findViewById(R.id.twitter_searchbox_button);
        searchButton.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                EditText searchTextBox = (EditText) TwitterListFragment.this.getActivity().findViewById(R.id.twitter_searchbox_textbox);                
    ...
    private void getHomeTimeline() {
        new TwitterHometimelineTask().execute(this.getActivity());
    }
    ...
    class FriendStatusAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (rowView == null) {
                LayoutInflater vi = (LayoutInflater) TwitterListFragment.this.getActivity().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    ...
    class TwitterHometimelineTask extends AsyncTask<Context, Integer, Integer> {
        ...
        protected void onPreExecute() {
            pd = ProgressDialog.show(
                    TwitterListFragment.this.getActivity(), 
